<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{route('service.store') }}" method="POST">{{ csrf_field() }}
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <select name="service_name" class="form-control" required>
                <option value="" required >Select Service</option>
                <option value="First aid">First Aid</option>
                <option value="pyschological treatment">Pyschological treatment</option>
